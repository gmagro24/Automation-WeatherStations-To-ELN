...
LABGURU_WEATHERLINK_PARENT_FOLDER_ID= os.getenv("LABGURU_WEATHERLINK_PARENT_FOLDER_ID")
LABGURU_LICOR_PARENT_FOLDER_ID= os.getenv("LABGURU_LICOR_PARENT_FOLDER_ID")
